...
import tfar.gravitymod.common.util.BlockStateHelper;
import tfar.gravitymod.common.util.ReflectionLambdas;
...
//                FMLLog.info("Unknown attack");
    ...
    public void turn(float yaw, float pitch) {
        ...
        final double relativePitch = relativePY[Vec3dHelper.PITCH];
        final double relativeYaw = relativePY[Vec3dHelper.YAW];
        ...
        final double changedAbsolutePitch = absolutePY[Vec3dHelper.PITCH];
        final double changedAbsoluteYaw = (absolutePY[Vec3dHelper.YAW] % 360);
