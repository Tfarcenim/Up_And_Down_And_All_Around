package tfar.gravitymod.asm;

import org.objectweb.asm.Opcodes;
import tfar.gravitymod.asm.util.obfuscation.MethodDesc;
import tfar.gravitymod.asm.util.obfuscation.instructions.FieldInsn;
import tfar.gravitymod.asm.util.obfuscation.instructions.HookInsn;
import tfar.gravitymod.asm.util.obfuscation.instructions.MethodInsn;
import tfar.gravitymod.asm.util.obfuscation.names.FieldName;
...
import static tfar.gravitymod.asm.util.obfuscation.ObfuscationHelper.*;
import static tfar.gravitymod.asm.util.obfuscation.ObfuscationHelper.DOUBLE;
import static tfar.gravitymod.asm.util.obfuscation.ObfuscationHelper.FLOAT;
...
//    public static final ObjectClassName EntityFloatingItem = new ObjectClassName("uk/co/mysterymayhem/gravitymod/common/entities/EntityFloatingItem");
    public static final ObjectName EntityPlayerWithGravity = new ObjectName("tfar/gravitymod/asm/EntityPlayerWithGravity");
    public static final ObjectName GravityAxisAlignedBB = new ObjectName("tfar/gravitymod/common/util/boundingboxes/GravityAxisAlignedBB");
    public static final ObjectName ItemStackAndBoolean = new ObjectName("tfar/gravitymod/asm/util/ItemStackAndBoolean");
