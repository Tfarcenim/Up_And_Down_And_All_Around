...
import tfar.gravitymod.asm.patches.PatchEntityPlayerSP;
import tfar.gravitymod.asm.util.ItemStackAndBoolean;
...
import static tfar.gravitymod.api.EnumGravityDirection.*;
